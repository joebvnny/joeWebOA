...
public enum SortType {
    ...
    /**
     * exchange the nodes specified by given indices, if the indices are equal, do nothing
     * 
     * @param array array which hold the elements
     * @param p one index to exchange
     * @param q the other index to exchange
     */
